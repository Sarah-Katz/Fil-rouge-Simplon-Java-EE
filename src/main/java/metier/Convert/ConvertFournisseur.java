...
public class ConvertFournisseur {
	...
	public FournisseurDTO fourtodto(FournisseurDO fournisseurdo) {
		FournisseurDTO fournisseurdto = new FournisseurDTO(fournisseurdo.getIdfour(), fournisseurdo.getNom(), fournisseurdo.getProduits());
		return fournisseurdto;
	}

	public FournisseurDO fourtodo(FournisseurDTO fournisseurdto) {
		FournisseurDAOimpl fournisseurdao = new FournisseurDAOimpl();
		FournisseurDO fournisseurdo = fournisseurdao.create(fournisseurdto.getNom(), fournisseurdto.getProduits());
